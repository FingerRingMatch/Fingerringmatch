            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div
                            key={index}
                            className="flex items-center justify-center mb-8 transform transition-transform duration-700 hover:scale-105"
                        >
                            <Card className="w-full bg-white shadow-lg rounded-lg transition-all hover:shadow-xl">
